...
use crate::interrupts::RotCounter;
use crate::movement::engine::Engine;
use crate::timing::pwm::PwmPinOps;

pub struct Movement<LPWM, LF, LB, RPWM, RF, RB> where
    LPWM: PwmPinOps,
    LF: PinOps,
    LB: PinOps,
    RPWM: PwmPinOps,
...
impl<LPWM, LF, LB, RPWM, RF, RB> Movement<LPWM, LF, LB, RPWM, RF, RB> where
    ...
    RB: PinOps,
{
    pub fn new(left: Engine<LPWM, LF, LB>, right: Engine<RPWM, RF, RB>, rot_counter: RotCounter) -> Self {
        Self {
            left,
            right,
            rot_counter
